defmodule MonkeyClawWeb.Layouts do
  @moduledoc """
  ...
  Standard layout with a header, centered content area, and flash
  messages. Used by pages that are not the full-screen chat interface.

  ## Examples

      layout: {MonkeyClawWeb.Layouts, :app}
