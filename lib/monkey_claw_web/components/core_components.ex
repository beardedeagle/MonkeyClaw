defmodule MonkeyClawWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MonkeyClawWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MonkeyClawWeb.Gettext, "errors", msg, opts)
    end
  end
